...
public class BodyAPITest {
	...
	public void bodyWithFormDataMultiPartTest() {
		...
		Response response = RestAssured.given()
				...
				.multiPart("fileName", new File("/Users/vinna/Desktop/Auth_PDF.pdf"))
				//need to create file in the path -- the response file is encoded base 64 format
			.when()
				.post("/post");
	...
	public void bodyWithBinaryFileTest() {
		...
		Response response = RestAssured.given()
					...
					.body(new File("/Users/vinna/Desktop/Auth_PDF.pdf")) 
					//need to create file in the path 
			.when()
				.post("/post");
